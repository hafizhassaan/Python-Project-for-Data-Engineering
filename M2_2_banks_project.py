...
def extract(url, table_attribs):
    ...
    for row in rows[1:]:
        col = row.find_all("td")
        data_dict = {
            "Name": col[1].find_all("a")[1]["title"].strip(),
...
# Download the following url using wget
# url_to_download_exchange_rate = "https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBMSkillsNetwork-PY0221EN-Coursera/labs/v2/exchange_rate.csv"
